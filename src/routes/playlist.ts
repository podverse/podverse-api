...
router.post('/', validatePlaylistCreate, createPlaylistLimiter, jwtAuth, hasValidMembership, async (ctx) => {
  try {
...
router.patch('/', validatePlaylistUpdate, updatePlaylistLimiter, jwtAuth, async (ctx) => {
  try {
