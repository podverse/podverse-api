      ...
      chai
        ...
        .end((err, res) => {
          ...
          chaiExpect(episode.mediaUrl).to.equal(
            'https://www.podtrac.com/pts/redirect.mp3/pdst.fm/e/chtbl.com/track/524GE/traffic.megaphone.fm/VMP3630362992.mp3'
          )
    ...
    test('when the user is logged in: unsubscribe from playlist', async (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          chaiExpect(res.body).to.eql(['zXSkVlr7'])
    ...
    test('when the user is logged in: subscribe to playlist', async (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          chaiExpect(res.body).to.eql(['zXSkVlr7', 'wgOok7Xp'])
