      ...
      test('id: bvVjsQCH', async (done) => {
        chai.request(global.app)
          ...
          .end((err, res) => {
            ...
            chaiExpect(queueItem.createdAt).to.equal('2020-03-02T22:02:57.865Z')
            chaiExpect(queueItem.updatedAt).to.equal('2020-03-02T23:05:24.052Z')
            ...
            chaiExpect(queueItem.episode.pubDate).to.equal('2020-02-19T20:00:00.000Z')
            chaiExpect(queueItem.episode.title).to.equal('#1428 - Brian Greene')
            chaiExpect(queueItem.episode.podcastId).to.equal('yKyjZDxsB')
            chaiExpect(queueItem.episode.createdAt).to.equal('2020-03-02T21:17:08.749Z')
            chaiExpect(queueItem.episode.updatedAt).to.equal('2020-04-03T06:51:11.489Z')
            ...
            chaiExpect(queueItem.episode.podcast.feedLastUpdated).to.equal('2020-04-02T19:00:00.000Z')
            ...
            chaiExpect(queueItem.episode.podcast.lastEpisodePubDate).to.equal('2020-04-02T19:00:00.000Z')
            ...
            chaiExpect(queueItem.episode.podcast.createdAt).to.equal('2020-03-02T21:17:08.665Z')
            chaiExpect(queueItem.episode.podcast.updatedAt).to.equal('2020-04-03T06:51:07.230Z')
      ...
      test('Logged in', async (done) => {
        chai.request(global.app)
          ...
          .end((err, res) => {
            ...
            chaiExpect(queueItem.createdAt).to.equal('2020-03-02T22:37:36.073Z')
            chaiExpect(queueItem.updatedAt).to.equal('2020-03-02T22:58:19.378Z')
            ...
            chaiExpect(queueItem.episode.pastYearTotalUniquePageviews).to.equal(5)
            chaiExpect(queueItem.episode.pastAllTimeTotalUniquePageviews).to.equal(6)
            chaiExpect(queueItem.episode.pubDate).to.equal('2020-03-02T05:01:00.000Z')
            ...
            chaiExpect(queueItem.episode.createdAt).to.equal('2020-03-02T21:17:39.462Z')
            chaiExpect(queueItem.episode.updatedAt).to.equal('2020-04-03T06:52:52.361Z')
            ...
            chaiExpect(queueItem.episode.podcast.feedLastParseFailed).to.equal(false)
            chaiExpect(queueItem.episode.podcast.feedLastUpdated).to.equal('2020-04-01T04:01:00.000Z')
            chaiExpect(queueItem.episode.podcast.guid).to.equal(null)
            chaiExpect(queueItem.episode.podcast.hideDynamicAdsWarning).to.equal(false)
            ...
            chaiExpect(queueItem.episode.podcast.isPublic).to.equal(true)
            chaiExpect(queueItem.episode.podcast.language).to.equal('en-us')
            chaiExpect(queueItem.episode.podcast.lastEpisodePubDate).to.equal('2020-04-01T04:01:00.000Z')
            ...
            chaiExpect(queueItem.episode.podcast.type).to.equal('episodic')
            chaiExpect(queueItem.episode.podcast.createdAt).to.equal('2020-03-02T21:17:39.426Z')
            chaiExpect(queueItem.episode.podcast.updatedAt).to.equal('2020-04-03T06:52:51.657Z')
      ...
      test('Logged in', async (done) => {
        chai.request(global.app)
          ...
          .end((err, res) => {
            ...
            chaiExpect(queueItem.createdAt).to.equal('2020-03-02T22:38:16.464Z')
            chaiExpect(queueItem.updatedAt).to.equal('2020-05-26T01:21:42.163Z')

            chaiExpect(queueItem.owner.id).to.equal('QMReJmbE')
            chaiExpect(queueItem.owner.isPublic).to.equal(false)
            chaiExpect(queueItem.owner.name).to.equal('Kyle')
            ...
            chaiExpect(queueItems[1].createdAt).to.equal('2020-03-02T22:38:21.768Z')
            chaiExpect(queueItems[1].updatedAt).to.equal('2020-05-26T01:22:00.712Z')

            chaiExpect(queueItems[1].owner.id).to.equal('QMReJmbE')
            chaiExpect(queueItems[1].owner.isPublic).to.equal(false)
            chaiExpect(queueItems[1].owner.name).to.equal('Kyle')
