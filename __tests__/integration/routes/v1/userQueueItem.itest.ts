      ...
      chai
        ...
        .end((err, res) => {
          ...
          chaiExpect(res.body.message).to.equal(
            'insert or update on table "userQueueItems" violates foreign key constraint "FK_2367e28002d5b0e577e5084b967"'
          )
          chaiExpect(Object.keys(res.body).length).to.equal(1)
    ...
    test('MediaRef Invalid', async (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          chaiExpect(res.body.message).to.equal(
            'insert or update on table "userQueueItems" violates foreign key constraint "FK_5d3167b5c0df34e3a550fd8d6e8"'
          )
          chaiExpect(Object.keys(res.body).length).to.equal(1)
    ...
    test('Get', async (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          chaiExpect(userQueueItemsEpisode.episodeMediaUrl).to.equal(
            'https://dts.podtrac.com/redirect.mp3/www.buzzsprout.com/1/814110-7-launch-your-new-podcast.mp3?blob_id=1707517'
          )
          ...
          chaiExpect(userQueueItemsEpisode.podcastImageUrl).to.equal(
            'https://storage.buzzsprout.com/variants/67b7vYUiagqpNz9ZG5qwSFmE/f81607a3cd537406cf0cf506c726bfe2824c5e584c9e9dc5e04e42436c820a79?.jpg'
          )
          chaiExpect(userQueueItemsEpisode.podcastShrunkImageUrl).to.equal(
            'https://storage.buzzsprout.com/variants/67b7vYUiagqpNz9ZG5qwSFmE/f81607a3cd537406cf0cf506c726bfe2824c5e584c9e9dc5e04e42436c820a79?.jpg'
          )
          ...
          chaiExpect(userQueueItemsClip.episodeMediaUrl).to.equal(
            'https://dts.podtrac.com/redirect.mp3/www.buzzsprout.com/1/814110-7-launch-your-new-podcast.mp3?blob_id=1707517'
          )
          ...
          chaiExpect(userQueueItemsClip.podcastImageUrl).to.equal(
            'https://storage.buzzsprout.com/variants/67b7vYUiagqpNz9ZG5qwSFmE/f81607a3cd537406cf0cf506c726bfe2824c5e584c9e9dc5e04e42436c820a79?.jpg'
          )
          chaiExpect(userQueueItemsClip.podcastShrunkImageUrl).to.equal(
            'https://storage.buzzsprout.com/variants/67b7vYUiagqpNz9ZG5qwSFmE/f81607a3cd537406cf0cf506c726bfe2824c5e584c9e9dc5e04e42436c820a79?.jpg'
          )
