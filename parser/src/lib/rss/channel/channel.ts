...
import { handleParsedChannelAbout } from "@parser/lib/parser/rss/channel/channelAbout";
import { handleParsedChannelChat } from "@parser/lib/parser/rss/channel/channelChat";
import { handleParsedChannelDescription } from "@parser/lib/parser/rss/channel/channelDescription";
import { handleParsedChannelFunding } from "@parser/lib/parser/rss/channel/channelFunding";
import { handleParsedChannelImage } from "@parser/lib/parser/rss/channel/channelImage";
import { handleParsedChannelLicense } from "@parser/lib/parser/rss/channel/channelLicense";
import { handleParsedChannelLocation } from "@parser/lib/parser/rss/channel/channelLocation";
import { handleParsedChannelPerson } from "@parser/lib/parser/rss/channel/channelPerson";
import { handleParsedChannelPodroll } from "@parser/lib/parser/rss/channel/channelPodroll";
import { handleParsedChannelRemoteItem } from "@parser/lib/parser/rss/channel/channelRemoteItem";
import { handleParsedChannelSocialInteract } from "@parser/lib/parser/rss/channel/channelSocialInteract";
import { handleParsedChannelTrailer } from "@parser/lib/parser/rss/channel/channelTrailer";
import { handleParsedChannelTxt } from "@parser/lib/parser/rss/channel/channelTxt";
import { handleParsedChannelValue } from "@parser/lib/parser/rss/channel/channelValue";
